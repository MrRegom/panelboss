 ...
 */
// Corregimos las rutas para subir un nivel (../)
    ...
    <section class="hero-wrap">
        <div class="c-slide">
            <div class="c-text">
                ...
                <p style="font-size:18px; color:#515154; margin-bottom:30px">El POS m&aacute;s r&aacute;pido de Chile. 100% Offline y Boletas Electr&oacute;nicas.</p>
    ...
    <section class="pricing" id="planes">
        ...
        <div class="price-grid">
            <div class="p-card">
                ...
                <ul class="p-features"><li>1 Punto de Venta</li><li>Boletas Electrónicas SII</li></ul>
            ...
            <div class="p-card featured">
                ...
                <p>Un solo pago para siempre.</p>
                <ul class="p-features"><li>3 Puntos de Venta</li><li>Boletas y Facturas SII</li></ul>
            ...
            <div class="p-card">
                ...
                <ul class="p-features"><li>Cajas ilimitadas</li><li>Multi-sucursal</li></ul>
                <a href="/mercadopago/checkout.php?plan=empresa" class="btn-apple" style="width:100%">Contratar</a>
            </div>
        </div>
    </section>
    <footer><p>CajaYa &copy; 2026 — Ingeniería Chilena 🇨🇱</p></footer>
</body>
</html>
