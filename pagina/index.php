<?php
/**
 * index.php — Landing Page CAJAYA ELITE FINAL (EPIC INTRO & CLEAN HERO)
 */
...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; scroll-behavior: smooth; }
        ...
        .loader-bar-fill { 
            width: 0%; height: 100%; background: var(--brand-purple); 
            animation: fillLoader 3s cubic-bezier(0.65, 0, 0.35, 1) forwards; 
        ...
        nav { background: rgba(255, 255, 255, 0.95); backdrop-filter: blur(30px); border-bottom: 1px solid rgba(0,0,0,0.05); height: 70px; display: flex; align-items: center; justify-content: center; position: fixed; width: 100%; top: 30px; z-index: 8000; }
        ...
        .hero { position: relative; width: 100%; height: 90vh; background: #000; overflow: hidden; z-index: 1000; margin-top: 100px; }
        .hero-bg { position: absolute; top: 0; left: 0; width: 100%; height: 100%; z-index: 1; }
        /* IMAGEN LIMPIA DE ALTA CALIDAD SIN LETRAS */
        .hero-bg img { 
            width: 100%; height: 100%; object-fit: cover; 
            filter: brightness(0.6); animation: kenBurns 40s infinite alternate; 
        }
        @keyframes kenBurns { 0% { transform: scale(1); } 100% { transform: scale(1.1); } }
        
        .hero-overlay { position: absolute; top: 0; left: 0; width: 100%; height: 100%; z-index: 2; background: linear-gradient(90deg, #000 0%, rgba(0,0,0,0.4) 60%, transparent 100%); }
        ...
        .hero-content h1 { font-size: clamp(2.5rem, 6vw, 4.8rem); font-weight: 800; line-height: 1.05; margin-bottom: 25px; }
        .hero-content p { font-size: clamp(1.1rem, 2vw, 1.4rem); opacity: 0.9; margin-bottom: 50px; max-width: 650px; line-height: 1.6; }
        
        .btn-hero { 
            background: var(--brand-purple); color: #fff; padding: 22px 50px; border-radius: 15px; 
        ...
        .btn-hero:hover { transform: translateY(-5px); background: var(--brand-glow); border-color: #fff; box-shadow: 0 20px 50px rgba(106, 27, 154, 0.6); }
        ...
        .p-card { background: #fff; padding: 60px 45px; border-radius: 35px; border: 2px solid #f2f2f2; transition: var(--transition); cursor: pointer; position: relative; overflow: hidden; }
        .p-card.selected { border: 3px solid var(--brand-purple); background: #faf8ff; }
        .p-price { font-size: 50px; font-weight: 800; margin-bottom: 40px; }
        ...
        .f-col h4 { font-size: 13px; color: rgba(255,255,255,0.3); margin-bottom: 30px; letter-spacing: 2px; text-transform: uppercase; }
        .f-col a { color: rgba(255,255,255,0.6); text-decoration: none; display: block; margin-bottom: 15px; font-size: 15px; }
        ...
        @media (max-width: 768px) {
            ...
            .hero-overlay { background: linear-gradient(0deg, #000 30%, rgba(0,0,0,0.6) 100%); }
            .hero-content { padding: 0 8%; text-align: center; align-items: center; }
            .hero-content h1 { font-size: 2.5rem; margin-top: 80px; }
...
<body>
    ...
    <div class="hero">
        <div class="hero-bg">
            <!-- IMAGEN LIMPIA DE ALTA CALIDAD (UNSPLASH) - SIN TEXTO -->
            <img src="https://images.unsplash.com/photo-1556742044-3c52d6e88c62?q=80&w=2070&auto=format&fit=crop" alt="Retail Tech">
        </div>
    ...
    <section class="pricing" id="planes">
        <div class="p-grid">
            <div class="p-card reveal" onclick="selectPlan(this)">
                ...
                <ul style="list-style:none; line-height:2.5; font-size:16px; margin-bottom:40px;">
                ...
                <a href="/mercadopago/checkout.php?plan=mensual" style="background:#f8f9fa; color:#000; text-align:center; padding:18px; border-radius:15px; font-weight:700; text-decoration:none; display:block; border:1px solid #eee;">Seleccionar</a>
            </div>
            <div class="p-card selected reveal" onclick="selectPlan(this)">
                ...
                <a href="/mercadopago/checkout.php?plan=lifetime" style="background:var(--brand-purple); color:#fff; text-align:center; padding:18px; border-radius:15px; font-weight:700; text-decoration:none; display:block;">Comprar Licencia</a>
            </div>
            <div class="p-card reveal" onclick="selectPlan(this)">
                ...
                <a href="/mercadopago/checkout.php?plan=empresa" style="background:#f8f9fa; color:#000; text-align:center; padding:18px; border-radius:15px; font-weight:700; text-decoration:none; display:block; border:1px solid #eee;">Contactar</a>
            </div>
        </div>
    </section>
    ...
    <section class="faq">
        ...
        <div class="faq-grid">
            ...
            <div class="faq-item reveal">
                ...
                <p>CajaYa es Offline-First. Sigue vendiendo; los datos se subirán cuando vuelva la señal.</p>
            </div>
        </div>
    </section>
    ...
    <footer class="footer">
        <div class="f-grid">
            <div class="f-col">
                <img src="assets/img/logo.png" style="height:45px; margin-bottom:30px; filter:brightness(0) invert(1);">
                <p style="opacity:0.5; font-size:14px; line-height:1.6;">Digitalizando el comercio chileno con tecnología robusta y certificada por el SII.</p>
            </div>
            <div class="f-col">
                <h4>Ecosistema</h4>
                <a href="#">Panel Boss</a>
