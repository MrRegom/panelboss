        ...
        <div class="container">
            <div class="pricing-grid">
                <div class="plan-card">
                    ...
                    <a href="/panelboss/webpay/checkout.php" class="btn-main" style="background: transparent; border: 1px solid var(--primary); justify-content: center;">Suscribirse</a>
                </div>
                <div class="plan-card popular">
                    ...
                    <a href="/panelboss/webpay/checkout.php" class="btn-main" style="justify-content: center;">Comprar Licencia Ahora</a>
                </div>
                <div class="plan-card">
                    <h3>Plan Premium</h3>
