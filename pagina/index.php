<?php
/**
 * index.php — Landing Page CAJAYA ELITE MASTER (ROBUST FOOTER & ALL FEATURES)
 */
...
$plans = [];
foreach ($plansRaw as $p) { $plans[trim($p['slug'])] = $p; }
...
<head>
    <meta charset="UTF-8">
    <title>CajaYa — Ecosistema POS de Elite</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; scroll-behavior: smooth; }
        ...
        .p-price span { font-size: 18px; color: #888; }
        ...
        .f-col p { color: rgba(255,255,255,0.5); line-height: 1.8; margin-bottom: 30px; }
        .f-col a { color: rgba(255,255,255,0.7); text-decoration: none; display: block; margin-bottom: 15px; transition: 0.3s; }
        .f-col a:hover { color: var(--brand-purple); padding-left: 8px; }
        .f-socials { display: flex; gap: 20px; }
        .f-socials a { font-size: 20px; color: #fff; opacity: 0.4; transition: 0.3s; }
        .f-socials a:hover { opacity: 1; color: var(--brand-purple); }
        .f-bottom { border-top: 1px solid rgba(255,255,255,0.05); padding-top: 50px; text-align: center; color: rgba(255,255,255,0.15); font-size: 13px; }

        .reveal { opacity: 0; transform: translateY(40px); transition: 1s var(--transition); }
        .reveal.visible { opacity: 1; transform: translateY(0); }

        @media (max-width: 768px) {
            .hero-content { padding: 80px 30px; text-align: center; }
            .hero-overlay { background: linear-gradient(0deg, #000 30%, rgba(0,0,0,0.5) 100%); }
            .p-grid { grid-template-columns: 1fr; }
            .f-grid { grid-template-columns: 1fr; text-align: center; gap: 60px; }
...
<body>
    ...
    <div class="hero">
        ...
        <div class="hero-content">
            ...
            <a href="#planes" class="btn-brand" style="text-decoration:none;">Ver Planes de Inversión</a>
        </div>
    </div>
        ...
        <div class="f-container">
            <div class="f-grid">
                <div class="f-col">
                    ...
                    <p>Digitalizando el corazón del comercio chileno con tecnología robusta, elegante y certificada por el SII.</p>
                    <div class="f-socials">
